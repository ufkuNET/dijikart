...
// Mail template'leri - Outlook Uyumlu
const mailTemplates = {
                   ...
                   <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #e3f2fd; border: 2px solid #2196f3; border-radius: 8px; margin: 25px 0;">
                     <tr>
                       <td style="padding: 25px;">
                         <h3 style="color: #1976d2; margin: 0 0 15px 0; font-size: 18px;">Kullanıcı Giriş Bilgilerin Bu:</h3>
                               ...
                               <td style="padding: 12px 0; border-bottom: 1px solid #f0f0f0;">
                                 <table width="100%" cellpadding="0" cellspacing="0">
                                   <tr>
                                     ...
                                     <td>
                                       <a href="http://${domain}/" style="color: #2196f3; font-weight: bold; text-decoration: none; font-size: 16px;">
                                         ${domain}
                                       </a>
                                     </td>
                                   </tr>
                  ...
                  <table width="100%" cellpadding="0" cellspacing="0" style="background-color: #f8f9fa; border: 2px solid #e9ecef; border-radius: 8px; margin: 25px 0;">
                    <tr>
                      <td style="padding: 25px;">
                        ...
                        <p style="margin: 0;">
                          <a href="http://${domain}/${customUrl}" style="color: #007bff; font-size: 20px; font-weight: bold; text-decoration: none;">
                            ${domain}/${customUrl}
                          </a>
                        </p>
                      </td>
                        ...
                        <table cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="background-color: #667eea; border-radius: 25px; padding: 15px 30px;">
                              <a href="http://${domain}/" style="color: #ffffff; text-decoration: none; font-size: 16px; font-weight: bold;">
  ...
  qrPackage: (userName, packageName, qrAmount, price, email, invoiceNumber, discountAmount, finalPrice, domain = 'qrtoo.de') => `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="utf-8">
                        ...
                        <table cellpadding="0" cellspacing="0">
                          <tr>
                            <td style="background-color: #dc3545; border-radius: 25px; padding: 15px 30px;">
                              <a href="${resetLink}" style="color: #ffffff; text-decoration: none; font-size: 16px; font-weight: bold;">
                                Şifremi Sıfırla
                              </a>
                            </td>
                          </tr>
